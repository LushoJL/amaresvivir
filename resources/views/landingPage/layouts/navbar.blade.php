...
<nav class="navbar-expand-lg sticky-top navbar-dark bg-dark nav-personalizado pt-3 pb-3">
    ...
    <div class=" collapse navbar-collapse " id="navbarToggler">
        <ul class="nav navbar-nav  nav-fill">
            <li class="nav-item">
                <a class="flex-lg-fill text-lg-center nav-link naranjado mt-1 mr-1 mb-1  {{ $activePage == 'inicio' ? ' active' : '' }} " href="{{secure_url('/')}}" style="font-size: 30px">INICIO</a>
            </li>
            ...
            <li class="nav-item dropdown">
                <a class="flex-lg-fill text-lg-center nav-link naranjado m-1 dropdown-toggle nav-actividadesJuegos {{ ($activePage == 'niño' || $activePage == 'joven' || $activePage == 'adulto') ? ' active' : '' }}" data-toggle="dropdown" href="{{secure_url('/actividades-juegos')}}" >ACTIVIDADES <br>Y JUEGOS</a>
            ...
            <li class="nav-item"> <a class="flex-lg-fill text-lg-center nav-link plomo m-1 {{ $activePage == 'test' ? ' active' : '' }}" style="font-size:30px" href="{{ secure_url('/test') }}">TEST</a></li>
            <li class="nav-item"> <a class="flex-lg-fill text-lg-center nav-link naranjado m-1 {{ $activePage == 'nosimportas' ? ' active' : '' }}" href="{{ secure_url('/nos-importas-tu') }}">TU!! <br> NOS IMPORTAS</a></li>
            <li class="nav-item"> <a class="flex-lg-fill text-lg-center nav-link plomo m-1 {{ $activePage == 'tuhistoria' ? ' active' : '' }}" href="{{ secure_url('/tu-historia') }}">TU <br>HISTORIA</a></li>
            <li class="nav-item"> <a class="flex-lg-fill text-lg-center nav-link naranjado mt-1 ml-1 mb-1 {{ $activePage == 'noticia' ? ' active' : '' }}" href="{{ secure_url('/noticia') }}">NOTICIAS<br> Y NOVEDADES</a></li>
        </ul>
    </div>
