...
<div class="container">
    <div class="row pt-5">
        <div class="col-md-6">
            <center>
                <img src="{{secure_asset('images/ninioactividades/niñoactividades.png')}}" alt="niño" width="200px" class="mt-5">
        ...
        <div class="col-md-6">
            <center>
                <img src="{{secure_asset('images/ninioactividades/niñaactividades.png')}}" alt="niño" width="200px" class="mt-4">
                <center>
